...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
			<div id="site-header">
				<a href="http://store.warchestboutique.com">
					<!--<img src="<?php //header_image(); ?>" width="<?php //echo 250//get_custom_header()->width; ?>" height="<?php //echo 119 //get_custom_header()->height; ?>" alt=""> -->
