...
add_in_table_thumb($entry->id,$entry->link,$entry->images->standard_resolution->url,$entry->images->thumbnail->url,'hashtag','',$hash,$caption,$entry->likes->count,$entry->user->username,$entry->user->profile_picture,$entry->user->username,'',time());
 }
}
