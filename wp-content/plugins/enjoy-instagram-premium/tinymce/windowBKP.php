...
<option value="false" selected> No </option>
 ...
 <table class="form-table">
  ...
  <tr valign="top">
                     ...
                     <td style="width: 65%;"><div class="ei_block">
...
You can add others moderated hashtag going to <a target="_blank" href="<?php echo admin_url('options-general.php?page=enjoyinstagram_plugin_options&tab=enjoyinstagram_moderated_settings'); ?>">setting moderate page</a>
            ...
            <table class="form-table">
				...
				<?php for ($i = 1; $i <= 10; $i++) { ?>
                                    ...
                                    <br />Animate In: <select name="enjoyinstagram_carousel_animatein"  id="enjoyinstagram_carousel_animatein">
          ...
          <option value="slideInRight" <?php if (get_option('enjoyinstagram_carousel_animatein_default')=='slideInRight') echo "selected='selected'";?>>slideInRight</option>
                                    ...
                                    <br />Animate Out: <select name="enjoyinstagram_carousel_animateout"  id="enjoyinstagram_carousel_animateout">
...
<br />Prev Button Text: <input type="text" value="<?php echo get_option('enjoyinstagram_carousel_navigation_prev_default'); ?>" name="enjoyinstagram_carousel_navigation_prev"  id="enjoyinstagram_carousel_navigation_prev">
...
<input type="number" name="enjoyinstagram_carousel_autoplay_timeout" id="enjoyinstagram_carousel_autoplay_timeout" value="<?php echo get_option('enjoyinstagram_carousel_autoplay_timeout_default'); ?>" class="ei_sel"><br />
                                        Speed Autoplay:
<input type="number" name="enjoyinstagram_carousel_autoplay_speed" id="enjoyinstagram_carousel_autoplay_speed" value="<?php echo get_option('enjoyinstagram_carousel_autoplay_speed_default'); ?>" class="ei_sel"><br />
                                </div>
                           </div> 
                            <hr />
                            <div class="ei_block">
                                ...
                                <div class="ei_settings_float_block">
<input type="number" name="enjoyinstagram_carousel_slidespeed" value="<?php echo get_option('enjoyinstagram_carousel_slidespeed_default'); ?>" class="ei_sel" id="enjoyinstagram_carousel_slidespeed"> ms
                            ...
                            <div class="ei_block">
                                ...
                                <div class="ei_settings_float_block">
                               Hide Bars Delay: <input type="number" value="<?php echo get_option('enjoyinstagram_carousel_hidebarsdelay_default'); ?>" name="enjoyinstagram_carousel_hidebarsdelay" class="ei_sel" id="enjoyinstagram_carousel_hidebarsdelay"> ms ( 0 to always show caption and action bar )<br />
                                    Hide Bars On Mobile: <select name="enjoyinstagram_carousel_hidebarsmobile" class="ei_sel" id="enjoyinstagram_carousel_hidebarsmobile">
                     ...
                     <tr valign="top">
                        <td>
                            <div class="ei_block">
                                ...
                                <div class="ei_settings_float_block">
<input type="number" value="<?php echo get_option('enjoyinstagram_carousel_480px_default'); ?>" name="enjoyinstagram_carousel_480px" class="ei_sel" id="enjoyinstagram_carousel_480px">                           	
                                </div>
                            </div>
                        </td><td>
                            <div class="ei_block">
                                ...
                                <div class="ei_settings_float_block">
<input type="number" value="<?php echo get_option('enjoyinstagram_carousel_600px_default'); ?>" name="enjoyinstagram_carousel_600px" class="ei_sel" id="enjoyinstagram_carousel_600px">                           	
                            ...
                            <div class="ei_block">
                                ...
                                <div class="ei_settings_float_block">
<input type="number" value="<?php echo get_option('enjoyinstagram_carousel_768px_default'); ?>" name="enjoyinstagram_carousel_768px" class="ei_sel" id="enjoyinstagram_carousel_768px">                           	
                            ...
                            <div class="ei_block">
                                ...
                                <div class="ei_settings_float_block">
<input type="number" value="<?php echo get_option('enjoyinstagram_carousel_1024px_default'); ?>" name="enjoyinstagram_carousel_1024px" class="ei_sel" id="enjoyinstagram_carousel_1024px">                           	
...
<option value="false" selected> No </option>
			            ...
			            <div class="animated  bounceInDown">
			              <section class="ac-container">
				<div>
					<input id="ac-1-2" name="accordion-1-2" type="radio" checked />
					<label for="ac-1-2">Inclusion Mode</label>
					<article class="ac-small">
 <table class="form-table">
                                            <tbody>
  <tr valign="top">
...
You can add others moderated hashtag going to <a target="_blank" href="<?php echo admin_url('options-general.php?page=enjoyinstagram_plugin_options&tab=enjoyinstagram_moderated_settings'); ?>">setting moderate page</a>
				...
				<div>
					<input id="ac-2-2" name="accordion-1-2" type="radio" />
					<label for="ac-2-2">Grid Settings</label>
					<article class="ac-medium">
           				<table class="form-table">
                                            <tbody>
                                            <tr valign="top">
...
<input type="number" value="<?php echo get_option('enjoyinstagram_grid_animation_speed_default'); ?>" name="enjoyinstagram_grid_animation_speed" class="ei_sel" id="enjoyinstagram_grid_animation_speed"> ms
                         ...
                         <div class="ei_block">
                                <div class="ei_settings_float_block ei_fixed">
                                    Interval the item(s) will be replaced:
                                </div>
                                <div class="ei_settings_float_block">
<input type="number" min="300" value="<?php echo get_option('enjoyinstagram_grid_interval_default'); ?>" name="enjoyinstagram_grid_interval" class="ei_sel" id="enjoyinstagram_grid_interval"> ms
                         ...
                         <div class="ei_block">
                                <div class="ei_settings_float_block ei_fixed">
                                    Items will switch when mouse on hover:
                                </div>
                                <div class="ei_settings_float_block">
<select name="enjoyinstagram_grid_onhover" class="ei_sel" id="enjoyinstagram_grid_onhover">
                                ...
                                <div class="ei_settings_float_block">
                               Hide Bars Delay: <input type="number" value="<?php echo get_option('enjoyinstagram_carousel_hidebarsdelay_default'); ?>" name="enjoyinstagram_grid_hidebarsdelay" class="ei_sel" id="enjoyinstagram_grid_hidebarsdelay"> ms ( 0 to always show caption and action bar )<br />
                            ...
                            <br />
                               ...
                               <select name="enjoyinstagram_grid_autoreload" class="ei_sel" id="enjoyinstagram_grid_autoreload">
                                    ...
                                    <input type="number" value="<?php echo get_option('enjoyinstagram_carousel_autoreload_value_default'); ?>" name="enjoyinstagram_grid_autoreload_value" class="ei_sel" id="enjoyinstagram_grid_autoreload_value"> ms ( time to reload )
                                            ...
                                            <div>
					<input id="ac-3-2" name="accordion-1-2" type="radio" />
					<label for="ac-3-2">Responsive Options</label>
					<article class="ac-medium">
                                        <table class="form-table">
                                            <tbody>
                                            <tr valign="top">
				...
				<div>
					<input id="ac-4-2" name="accordion-1-2" type="radio" />
					<label for="ac-4-2">Style Settings</label>
					<article class="ac-large">
...
<input type="submit" id="insert" name="insert" value="<?php _e("Insert", 'enjoyinstagram'); ?>" onClick="insertenjoyinstagramshortcode_polaroid();" />
 ...
 <input type="button" id="cancel" name="cancel" value="<?php _e("Cancel", 'enjoyinstagram'); ?>" onClick="tinyMCEPopup.close();" />
  ...
  <tr valign="top">
      ...
      <td style="width: 45%;"><h4>Not Moderate</h4>
          <h3>Users</h3>
      <br />
      <?php 
 foreach($array_utenti as $singolo_utente) { 
...
<span class="description" style="font-size:12px;">insert hashtags (without '#') separated by comma</span>             
      ...
      <td style="width: 45%;"><h4>Moderate</h4>
...
<?php } ?>
				...
				<div>
					...
					<article class="ac-medium">
                         ...
                         <div class="ei_block">
                                <div class="ei_settings_float_block ei_fixed">
                                    On Hover show Likes Count or Caption exceprt
                                </div>
                                <div class="ei_settings_float_block">
...
<input type="text"  name="enjoyinstagram_album_link_altro" value="<?php echo get_option('enjoyinstagram_album_link_altro_default'); ?>" id="enjoyinstagram_album_link_altro" <?php if (get_option('enjoyinstagram_album_link_default')!='altro') 
                            ...
                            <div class="ei_block">
                               ...
                               Hide Bars Delay: <input type="number" value="<?php echo get_option('enjoyinstagram_carousel_hidebarsdelay_default'); ?>" name="enjoyinstagram_album_hidebarsdelay" class="ei_sel" id="enjoyinstagram_album_hidebarsdelay"> ms ( 0 to always show caption and action bar )<br />
                                    Hide Bars On Mobile: <select name="enjoyinstagram_album_hidebarsmobile" class="ei_sel" id="enjoyinstagram_album_hidebarsmobile">
                                    <option value="true" <?php if (get_option('enjoyinstagram_carousel_hidebarsmobile_default')=='true') echo "selected='selected'";?>>Yes
                                    </option>
                                    <option value="false" <?php if (get_option('enjoyinstagram_carousel_hidebarsmobile_default')=='false') echo "selected='selected'";?>>No
                                    </option>
 ...
 <input type="button" id="cancel" name="cancel" value="<?php _e("Cancel", 'enjoyinstagram'); ?>" onClick="tinyMCEPopup.close();" />
				...
				<div>
					...
					<label for="ac-1-5">Select User:</label>
                                        <article class="ac-small" style="height: 300px;">
                                            <table class="form-table" style="width:100%;">
                                            <tbody>
  <tr valign="top">
                    
      <td>
          <p>To add other user go to bla bla bla</p>
